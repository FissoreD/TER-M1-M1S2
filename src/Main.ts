...
import { Teacher, teacherA3fromLast, teacherPairZeroAndOne } from "./Teacher.js";
...
// export let A = new HTML_LStar("01", teacherPairZeroAndOne);
export let A = new HTML_LStar("ab", teacherA3fromLast);
