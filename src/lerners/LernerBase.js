define(["require", "exports", "../tools/Utilities.js"], function (require, exports, Utilities_js_1) {
    ...
    class LernerBase {
        ...
        add_elt_in_S(new_elt, after_member = false) {
            let added_list = [];
            let prefix_list = (0, Utilities_js_1.generate_prefix_list)(new_elt);
        ...
        add_row(row_name, after_member = false) {
            this.E.forEach(e => {
                if (after_member && e == "")
                    this.observation_table[row_name] = (0, Utilities_js_1.boolToString)(!this.automaton.accept_word_nfa(row_name)[0]);
                else
