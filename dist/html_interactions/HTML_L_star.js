import{L_star}from"../lerners/L_star.js";import{HTML_LernerBase}from"./HTML_LernerBase.js";export class HTML_L_star extends HTML_LernerBase{constructor(teacher){super(new L_star(teacher))}close_message(close_rep){return`The table is not closed since
        ...
        I'm going to add the column "${new_col}" since \\(T(${s1+new_col}) \\neq T(${s2+new_col})\\)`}table_to_update_after_equiv(answer){this.lerner.add_elt_in_S(answer,true)}}
