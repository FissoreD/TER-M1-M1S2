...
An automaton \automaton{} is a computing device used in abstract computer science to understand a regular language \lang{} which can be seen as a set of words formed with the concatenation of zero or more letters \letter{} belonging to an alphabet, a finite set of symbols, noted \alphabet{}.
...
% \begin{theorem}
%   Every DFA has an unique minimum DFA representing the same langauge with the minimum number of states and to know if two DFAs are equivalent, we can minimize and compare them.
% \end{theorem}
