...
% Here are some examples of regular languages whose corresponding automata are shown in \cref{simple_automata}.
...
% \begin{theorem}
%   Every DFA has an unique minimal DFA representing the same language with the minimal number of states and to know if two DFAs are equivalent, we can minimize and compare them.
% \end{theorem}
